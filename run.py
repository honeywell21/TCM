...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=True, default='TCM',
                        help='model name, options: [TCM]')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_eb{}_{}'.format(
                args.model,
                args.data_path[:-4],
                args.features,
                args.seq_len,
            ...
            exp.test(setting)
            print('Inference time: ', time.time() - time_now2)
        ...
        ii = 0
        setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_eb{}_{}'.format(args.model_id,
            args.model,
            args.data_path[:-4],
            args.features,
            args.seq_len,
